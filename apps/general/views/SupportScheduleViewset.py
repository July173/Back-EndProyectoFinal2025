...
class SupportScheduleViewset(BaseViewSet):
    """
    ViewSet for managing SupportSchedule CRUD operations and custom endpoints.
    ...
    def retrieve(self, request, *args, **kwargs):
        """
        Retrieve information for a specific support schedule.
        """
    ...
    def update(self, request, *args, **kwargs):
        """
        Update all information for a support schedule.
        """
    ...
    def partial_update(self, request, *args, **kwargs):
        """
        Partially update fields for a support schedule.
        """
    ...
    def destroy(self, request, *args, **kwargs):
        """
        Physically delete a support schedule from the database.
        """
    ...
    def soft_delete(self, request, pk=None):
        """
        Perform a logical (soft) delete for the specified support schedule, marking it as inactive.
        """
